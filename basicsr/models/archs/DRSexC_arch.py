...
class FeedForward(nn.Module):
    def __init__(self, dim, ffn_expansion_factor, bias):
        ...
        self.dwconv5x5_2 = nn.Conv2d(hidden_features, hidden_features, kernel_size=5, stride=1, padding=2, groups=hidden_features , bias=bias)
    ...
    def forward(self, x):
        ...
        x1 = self.relu3_2(self.dwconv3x3_2(x1))
        x2 = self.relu5_2(self.dwconv5x5_2(x2))
